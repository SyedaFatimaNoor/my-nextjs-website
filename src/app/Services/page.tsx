    ...
    return (  
        <main className="flex flex-col items-center justify-center"> 
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4 "> 
                <h1 style={{ padding: '14px' }} className="text-3xl font-bold uppercase m-0 tracking-wider leading-loose text-white bg-opacity-10 rounded-lg shadow-lg p-4 md:p-6 lg:p-8 mt-12"> My Services </h1> 
                </div> 
                </div> 
                <div className="flex flex-col items-center justify-center w-full h-auto p-4">  
                <h2 className="text-5xl mt-3 font-bold uppercase tracking-wider bg-gradient-to-r from-purple-700 via-pink-500 to-red-500 bg-clip-text text-transparent mb-4">Our Expertise</h2>  
                <p className="text-center  text-gray-700 max-w-4xl leading-relaxed mx-auto ">  We offer a variety of services tailored to meet your needs. From web development to digital marketing,  
